...
public class RoundSun : MonoBehaviour {
    ...
    void Start() {
        Sun.position = Vector3.zero; // 行星初始位置
    ...
    void Update() {
        ...
        Mercury.RotateAround (Sun.position, a1, 20*Time.deltaTime); // 公转
        ...
        Mercury.Rotate (Vector3.up*50*Time.deltaTime); // 自转
        ...
        moon.transform.RotateAround (Earth.position, Vector3.up, 359 * Time.deltaTime); // 月球
    }
} 
