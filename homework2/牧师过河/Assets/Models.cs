...
namespace Models {
	...
	public class Move: MonoBehaviour {
		...
		public void setDest(Vector3 _dest) {
			dest = _dest;
			mid = _dest;
			if (_dest.y == transform.position.y) status = 2; 
			else {
				if (_dest.y < transform.position.y) mid.y = transform.position.y;	
	...
	public class CoastCon {
		GameObject coast;
		Vector3 from_pos = new Vector3(7,1,0);
		Vector3 to_pos = new Vector3(-7,1,0);
		Vector3[] positions;
		int status;	
		...
		public CoastCon(string _status) {
			positions = new Vector3[] {new Vector3(4.5F,2.25F,0), new Vector3(5.5F,2.25F,0), new Vector3(6.5F,2.25F,0), 
				new Vector3(7.5F,2.25F,0), new Vector3(8.5F,2.25F,0), new Vector3(9.5F,2.25F,0)};
	...
	public class BoatCon {
		GameObject boat;
		Move move;
		Vector3 fromPosition = new Vector3 (3, 1, 0);
		Vector3 toPosition = new Vector3 (-3, 1, 0);
		...
		public BoatCon() {
			status = 1;
			from_positions = new Vector3[] { new Vector3 (2.5F, 1.5F, 0), new Vector3 (3.5F, 1.5F, 0) };
			to_positions = new Vector3[] { new Vector3 (-3.5F, 1.5F, 0), new Vector3 (-2.5F, 1.5F, 0) };
